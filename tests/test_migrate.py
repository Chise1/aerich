        ...
        "m2m_fields": [
            {
                ...
                "docstring": None,
                "constraints": {},
                "generated_sql": {"mysql": None, "sqlite": None, "asyncpg": None},
                "db_constraint": True,
                ...
                "on_delete": "CASCADE",
                "_generated": True,
                "related_table_name": "product",
                "related_table_pk_name": "id",
                "backward_type": {"sqlite": "INT", "mysql": "INT", "asyncpg": "INT"},
                "forward_type": {"sqlite": "INT", "mysql": "INT", "asyncpg": "INT"},
            }
        ],
    },
    "models.Config": {
